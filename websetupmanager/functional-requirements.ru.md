...
> **Архивный baseline.** С 2026-08-21 этот документ заменён прямым продуктовым
> решением владельца станка, зафиксированным в
> [PRODUCT_REQUIREMENTS.ru.md](PRODUCT_REQUIREMENTS.ru.md). В частности, больше
> не нормативны multi-program Setup, validation/readiness/current workflow,
> managed-object-only публикация и library/card dashboard UX. Таблицы P0 и
> `AC-01`–`AC-20` ниже сохранены для истории и трассировки уже написанного кода;
> они не являются критериями приёмки текущей catalog-версии. Актуальные P0 и AC
> имеют префиксы `CAT-P0-*` и `CAT-AC-*`.

| Атрибут | Значение |
|---|---|
| Статус | Архивный baseline; заменён `PRODUCT_REQUIREMENTS.ru.md` 21 августа 2026 г. |
| Версия | 2.0 |
